...
$curso = obtenerCursoPorId($id_curso);
        ...
        <div class="contenedor-principal">
            <div class="info-publicacion">
                <section class="info-principal-galeria">
                    ...
                    <h2><?php echo $curso['nombre_del_curso'] ?></h2>
                ...
                <section class="descripcion">
                    ...
                    <div class="fila">
                        <div class="dato">
                            <span class="header">Informacion del Curso</span>
                            <span class="valor"><?php echo $curso['info_curso'] ?></span>
                        </div>
                        
                        <div class="dato">
                            <span class="header">Introduccion</span>
                            <span class="valor"><?php echo $propiedad['estado'] ?></span>
                        </div>
                        <div class="dato">
                            <span class="header">Requisitos</span>
                        ...
                        <div class="dato">
                            <span class="header">Programa </span>
